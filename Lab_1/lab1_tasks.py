...
img = cv2.imread('/home/kamal/CVPR_Labs/Lab_1/sphinx.jpg')  # Make sure to use your actual image path
...
blurred_img = convolve2d(grey_img, K, mode='valid')  # Apply the filter using convolution
